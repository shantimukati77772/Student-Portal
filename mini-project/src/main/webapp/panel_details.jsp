...
<div class="about-section">
  <h1>Panel Details</h1>
  <p>All the information regarding Panel are provided here.</p>
  
</div>

 
<h2 style="text-align:center">Our Panels</h2>
<div class="row">
<%
String sql = "select * from panel";
 ...
 while(resultset.next()){
    ...
    <div class="card">
      ...
      <div class="container">
        ...
        <h2>Panel Members</h2>
        <%Array members = resultset.getArray(2);
   	 String[] memb = (String[])members.getArray(); 
        for(int i=0;i<memb.length;i++) {%>
        
        <p class="title"><%out.println(memb[i]); %></p>

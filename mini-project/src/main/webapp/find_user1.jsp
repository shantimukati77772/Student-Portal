    ...
    <div class="main">
        <div class="container">
              <div class="topnav" id="myTopnav">
                  <h6 style = "float:top;float:right;color:white;">Faculty</h6>
 <a href="facultylogin.jsp">Student Lists</a>
  <a href="panel_details.jsp">Panel Information</a>
  <a href="Panel_information.jsp">Panel And Team</a>
  <a href="find_user1.jsp" class="active">Find_user</a>
...
<form method="POST" class="register-form" id="faculty_form" action = "faculty_found" style = "display:none;">
  <h2>Find Faculty</h2>

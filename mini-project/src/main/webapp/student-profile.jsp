        ...
        <ul class="nav navbar-nav navbar-nav-margin-left">
          <li class="dropdown active">
            ...
            <ul class="dropdown-menu">
              <li><a href="Panel_information.jsp">Notice</a></li>
            
              <li><a href="panel_details.jsp">Panel</a></li>
            </ul>
          </li>
 ...
 if(resultset.next()){
	 %>
        <div class="navbar-right">
          <ul class="nav navbar-nav navbar-nav-bordered navbar-nav-margin-right">
            ...
            <li class="dropdown user active">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li class="active"><a href="student-profile.jsp?val=<%=resultset.getString(18)%>"><i class="fa fa-user"></i> Profile</a></li>
          ...
          <a href="index.jsp" class="navbar-btn btn btn-primary">Log Out</a>
        </div>
      </div>
      <!-- /.navbar-collapse -->
    </div>
        ...
        <div class="col-md-9">
          ...
          <div class="tabbable paper-shadow relative" data-z="0.5">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a href="#"><i class="fa fa-info-circle"></i> <span class="hidden-sm hidden-xs">Academic Details</span></a></li>
            </ul>
            <!-- // END Tabs -->
              ...
              <div id="account" class="tab-pane active">
                <form class="form-horizontal">                
                  <div class="form-group col-sm-11">
                    ...
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString(2) %>" name="name" placeholder="Your Name" disabled="disabled">
                    </div>
                    <label for="reg_no" class="col-md-2 control-label">Registration No.:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString(1) %>" name="reg_no" placeholder="Registration no." disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="f_name" class="col-md-3 control-label">Father's Name:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString(3) %>" name="f_name" placeholder="Father's Name" disabled="disabled">
                    </div>
                    <label for="dob" class="col-md-2 control-label">Date of Birth:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString(4) %>" name="dob" placeholder="Date of Birth" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="department" class="col-md-3 control-label">Course:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString(5) %>" name="department" placeholder="Department" disabled="disabled">
                    </div>
                    <label for="program" class="col-md-2 control-label">Session:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString(8) %>" name="session" placeholder="Session" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="department" class="col-md-3 control-label">Department:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString(9) %>" name="department" placeholder="Department" disabled="disabled">
                    </div>
                    <label for="program" class="col-md-2 control-label">Program:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString(6) %>" name="program" placeholder="Program" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="branch" class="col-md-3 control-label">Branch:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString(7) %>" name="branch" placeholder="Branch" disabled="disabled">
                    </div>
                    <label for="semester" class="col-md-2 control-label">Semester:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString(10) %>" name="semester" placeholder="Semester" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="religion" class="col-md-3 control-label">Religion:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString(11) %>" name="religion" placeholder="Religion" disabled="disabled">
                    </div>
                    <label for="gender" class="col-md-2 control-label">Gender:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString(12) %>" name="gender" placeholder="Gender" disabled="disabled">
                    </div>
                  </div>
                  <h5 style="opacity: 100;" align="center" class="col-sm-12 col-sm-offset0">
                    <label align="center" style=  "color:#0084ff; border:1px; border-style:solid; border-color:#0084ff; padding: 1em;">Contact Details</label>
                  </h5>
              
                  <div class="form-group col-sm-11">
                    <label for="mobile" class="col-md-3 control-label">Mobile:</label>
                    <div class="col-md-3">
                      <input type="mobile" class="form-control" value="<%=resultset.getString(13) %>" name="mobile" placeholder="Mobile Number"disabled="disabled">
                    </div>
                    <label for="email" class="col-md-2 control-label">Email ID:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString(14) %>" name="email" placeholder="Your Email"disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="adhar" class="col-md-3 control-label">Aadhar Number:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString(15) %>" name="religion" placeholder="Aadhar Number" disabled="disabled">
                    </div>
                    <label for="address" class="col-md-2 control-label">Address:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString(16) %>" name="address" placeholder="Your Address" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="state" class="col-md-3 control-label">State:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString(17) %>" name="state" placeholder="Your Address" disabled="disabled">
                    </div>
                  </div>
 <%
...
%>	
                  ...
                  <div class="form-group margin-none"></div>
                </form>
              </div>
          ...
          <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
            ...
            <div class="panel-body list-group">
              <ul class="list-group list-group-menu">
                <li class="list-group-item"><a class="link-text-color" href="panel_details.jsp">Panel</a></li>
                <li class="list-group-item active"><a class="link-text-color" href="student-profile.jsp?val=<%=resultset.getString(18)%>">View Profile</a></li>
                <li class="list-group-item"><a class="link-text-color" href="Panel_information.jsp">Notice</a></li>

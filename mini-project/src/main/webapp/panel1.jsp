...
<%String s = request.getParameter("teams"); 
String s1=null;
%>
    ...
    <i class="fa fa-bars"></i>
            ...
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form" action = "panel_team">
                        <h2>Panel Assign </h2>
...
String sql = "select * from student_team where first = ?";
...
try {
 ...
 while(resultset.next()){
	 s1 = resultset.getString("faculty");
	 %> 
...
%>	
     ...
     <label for="semester">Panels :</label>
                            <div class="form-select">
...
String sql1 = "SELECT * FROM panel WHERE ? !=  ALL (panel_team)";
...
try {
 ...
 while(resultset.next()){
	 %> 
                                   ...
                                   <option value="<%=resultset.getString("panel_no") %>"><%=resultset.getString("panel_no") %> <%=resultset.getString("panel_team") %></option>

...
String sql = "select * from registration where name = ? and course = ? and program = ? and branch = ? and semester = ?";
    ...
    <div class="container parallax-layer" data-opacity="true">
      <div class="media v-middle">
        ...
        <div class="media-body">
          <h1 class="text-white text-display-1 margin-v-0"><%=resultset.getString("name") %></h1>
          
        </div>
        <div class="media-right">
          <button class="label bg-blue-500" onclick = "dis()">Edit</button>
          <script>
              ...
              <div id="account" class="tab-pane active">
                <form class="form-horizontal" method = "post" action = "update">
                  ...
                  <div class="form-group col-sm-11">
                    ...
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString("name") %>" name="name" placeholder="Your Name" disabled="disabled">
                    </div>
                    <label for="reg_no" class="col-md-2 control-label">Registration No.:</label>
                    <div class="col-md-3">
                      <input readonly type="text"  class="form-control" value="<%=resultset.getString("id") %>" name="reg_no" id = "reg_no" placeholder="Registration no." disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="f_name" class="col-md-3 control-label">Father's Name:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString("father_name") %>" name="f_name" placeholder="Father's Name" disabled="disabled">
                    </div>
                    <label for="dob" class="col-md-2 control-label">Date of Birth:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString("dob") %>" name="dob" placeholder="Date of Birth" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="department" class="col-md-3 control-label">Course:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString("course") %>" name="course" placeholder="Department" disabled="disabled">
                    </div>
                    <label for="program" class="col-md-2 control-label">Session:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString("session") %>" name="session" placeholder="Session" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="department" class="col-md-3 control-label">Department:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString("department") %>" name="department" placeholder="Department" disabled="disabled">
                    </div>
                    <label for="program" class="col-md-2 control-label">Program:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString("program") %>" name="program" placeholder="Program" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="branch" class="col-md-3 control-label">Branch:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString("branch") %>" name="branch" placeholder="Branch" disabled="disabled">
                    </div>
                    <label for="semester" class="col-md-2 control-label">Semester:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString("semester") %>" name="semester" placeholder="Semester" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="religion" class="col-md-3 control-label">Religion:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString("religion") %>" name="religion" placeholder="Religion" disabled="disabled">
                    </div>
                    <label for="gender" class="col-md-2 control-label">Gender:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString("gender") %>" name="gender" placeholder="Gender" disabled="disabled">
                    </div>
                  </div>
                  ...
                  <div class="form-group col-sm-11">
                    ...
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString("mobile") %>" name="mobile" placeholder="Mobile Number"disabled="disabled">
                    </div>
                    <label for="email" class="col-md-2 control-label">Email ID:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString("email") %>" name="email" placeholder="Your Email"disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group col-sm-11">
                    <label for="adhar" class="col-md-3 control-label">Aadhar Number:</label>
                    <div class="col-md-3">
                      <input type="text" class="form-control" value="<%=resultset.getString("aadhar") %>" name="aadhar" placeholder="Aadhar Number" disabled="disabled">
                    </div>
                    <label for="address" class="col-md-2 control-label">Address:</label>
                    <div class="col-md-4">
                      <input type="text" class="form-control" value="<%=resultset.getString("address") %>" name="address" placeholder="Your Address" disabled="disabled">
                    </div>
                  </div>
                  ...
                  <div class="form-group margin-none" align="center">
